...
file_snapnum28_noSF = '/Users/lokhorst/Eagle/emission_halpha_L0100N1504_27_test2_SmAb_C2Sm_32000pix_5.000000slice_zcen12.5_noSFR.npz' #### THIS IS 27 NOT 28
...
data_100 = get_halpha_SB.imreduce(data, int(round(factor_100Mpc)), log=True, method = 'average')
data_200 = get_halpha_SB.imreduce(data, int(round(factor_200Mpc)), log=True, method = 'average')
data_1000 = get_halpha_SB.imreduce(data, int(round(factor_1000Mpc)), log=True, method = 'average')
...
ax1 = plt.subplot(111)
get_halpha_SB.makemap(data_50[(25./100.*3200.):(75./100.*3200.),0:(50./100.*3200.)],size,ax1,xystarts = xystarts)
...
ax1.plot([50.-x_FOV_1000/2.,50.+x_FOV_1000/2.,50.+x_FOV_1000/2.,50.-x_FOV_1000/2.,50.-x_FOV_1000/2.],
         [10.+y_FOV_1000/2.,10.+y_FOV_1000/2.,10.-y_FOV_1000/2.,10.-y_FOV_1000/2.,10.+y_FOV_1000/2.],color='gray')
...
ax1.text(50.-x_FOV_50/2.,10.+y_FOV_1000/2.,'1000 Mpc away')

plt.savefig('HalphaSB_DragonflyFOVs_together.pdf')
plt.close()
...
xystarts = [50.-x_FOV_50/2.,10.-y_FOV_50/2.]
size     = [x_FOV_50, y_FOV_50]
get_halpha_SB.makemap(data_50[((50.-x_FOV_50/2.)/100.*3200.):((50.+x_FOV_50/2.)/100.*3200.),((10.-y_FOV_50/2.)/100.*3200.):((10.+y_FOV_50/2.)/100.*3200.)],size,ax1,xystarts = xystarts)
...
for ax, x_FOV, y_FOV, data_this in zip(axes, x_FOV_list, y_FOV_list, data_list):  ## maybe change zip to izip (from itertools import izip)
    xystarts = [50.-x_FOV/2.,10.-y_FOV/2.]
    size     = [x_FOV, y_FOV]
    get_halpha_SB.makemap(data_this[((50.-x_FOV/2.)/100.*3200.):((50.+x_FOV/2.)/100.*3200.),((10.-y_FOV/2.)/100.*3200.):((10.+y_FOV/2.)/100.*3200.)],size,ax,xystarts = xystarts)
